...
```{r results across package, eval=FALSE, include=TRUE, error=FALSE, fig.keep='all', message=FALSE, warning=FALSE, results='hide'}
library(multilateral)
library(IndexNumR)
...
```{r print results, eval=FALSE, include=FALSE}
