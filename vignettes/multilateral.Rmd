...
There are a few reasons this package was built. It is good for someone within the NZ Stats agency to fully understand how 
the building blocks of the calculation occurs, this is a fully transparent system, and not a black box. The methods available are those that Stats NZ are either using or intending to explore the use of.

The general things that separate this package are 

* Speed
* Flexibility

Below we compare the PriceIndices, IndexNumR, and multilateral package looking at how you would calculate the same thing and comparing the speeds.
