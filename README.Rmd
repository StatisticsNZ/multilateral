...
```{r table summary, echo=FALSE, message = FALSE}
...
summary <- as.data.frame(do.call(cbind, summary)) 
summary <- data.table::rbindlist(summary)
summary[,description:=NULL]
summary$Method <- methods

colnames(summary) <- c("Requires ID","Requires Features","Requires Quantity","Requires Weight","Can Restrict to Matched Sample","Method")
summary <- summary[,c("Method","Requires ID","Requires Features","Requires Quantity","Requires Weight","Can Restrict to Matched Sample")]
